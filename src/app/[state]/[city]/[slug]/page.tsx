          ...
          <article className="pointer-events-auto w-full max-w-[600px] bg-white dark:bg-gray-900 rounded-2xl shadow-xl overflow-hidden">
            ...
            <div className="px-4 py-8">
              ...
              {(venue.tagline ?? venue.type) && (
                <span className="inline-block mt-1.5 text-xs bg-gray-100 text-gray-600 px-2 py-0.5 rounded-full mb-6">
                  {venue.tagline ?? venue.type}
                </span>
              )}
              {isClaimed && (
                <span className="inline-block mt-1.5 text-xs bg-white text-blue-600 font-semibold px-2.5 py-1 rounded-full border border-blue-400 mb-6 ml-1">
