...
export default function VerificationLoginForm() {
  ...
  async function submit(e: React.FormEvent) {
    ...
    try {
      ...
      if (reason === 'invalid_password') {
        ...
        setError('Server is missing SEED_PASSWORD env var.')
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-neutral-50 p-4">
      ...
      >
        <h1 className="text-lg font-semibold text-neutral-900 mb-1">/verification</h1>
        <p className="text-sm text-neutral-600 mb-4">
          Venue claim requests. Same password as /seed.
        </p>
        <label htmlFor="verify-pw" className="block text-xs font-medium text-neutral-700 mb-1">
          Password
        </label>
        <input
          id="verify-pw"
