  ...
  return (
    ...
    >
      ...
      {photoViewerOpen && allPhotos.length > 0 && createPortal(
        ...
        >
          {/* Photo counter — centered at top, pointer-events-none so clicks pass through to the close button below. */}
          <div className="absolute top-0 left-0 right-0 flex justify-center px-4 py-3 bg-black/60 z-10 pointer-events-none">
